...
def run_mpc(task_id=0, seed=0):
    save_dir = os.path.join("scratch_dir/mpc_data/libero_object/test_agent_optimization", f"task{task_id}", f"seed{seed}")
...
if __name__ == "__main__":
    ...
    for task in [4]:
        ...
        with open(os.path.join("scratch_dir/mpc_data/libero_object/test_agent_optimization", f"task{task}", "result.txt"), "w") as f:
